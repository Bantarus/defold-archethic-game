...
---@param metadata_name hash|string name of the metadata entry
---@return table|nil values table of metadata values or <code>nil</code> if the entry does not exist
---@return constant|nil value_type numeric type of values or <code>nil</code>
