...
---@return number|nil handle handle to the loaded dump, or <code>nil</code> if no dump was found
...
---@return string|nil value value recorded in the crash dump, or <code>nil</code> if it didn't exist
