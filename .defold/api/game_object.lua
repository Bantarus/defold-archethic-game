...
---@param options table|nil optional options table
---@overload fun(url: string|hash|url, property: string|hash, value: any|table)
...
---@overload fun(): hash|nil
---@return hash|nil parent_id parent instance or <code>nil</code>
...
---Docs: https://defold.com/ref/stable/go/?q=go.exists#go.exists
---
...
---Docs: https://defold.com/ref/stable/go/?q=go.world_to_local_position#go.world_to_local_position
---
...
---Docs: https://defold.com/ref/stable/go/?q=go.world_to_local_transform#go.world_to_local_transform
---
---The function uses world transformation calculated at the end of previous frame.
...
---Docs: https://defold.com/ref/stable/go/?q=fixed_update#fixed_update
---
