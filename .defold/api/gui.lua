...
---Docs: https://defold.com/ref/stable/gui/?q=gui.get#gui.get
---
...
---<code>"size"</code>
---
---<code>"fill_angle"</code> (pie)
---
---<code>"inner_radius"</code> (pie)
---
---<code>"slice9"</code> (slice9)
---
...
---Docs: https://defold.com/ref/stable/gui/?q=gui.set#gui.set
---
...
---@param property string|constant property for which the animation should be canceled  <code>"position"</code>  <code>"rotation"</code>  <code>"euler"</code>  <code>"scale"</code>  <code>"color"</code>  <code>"outline"</code>  <code>"shadow"</code>  <code>"size"</code>  <code>"fill_angle"</code> (pie)  <code>"inner_radius"</code> (pie)  <code>"slice9"</code> (slice9) 
...
---@return constant blend_mode blend mode  <code>gui.BLEND_ALPHA</code>  <code>gui.BLEND_ADD</code>  <code>gui.BLEND_ADD_ALPHA</code>  <code>gui.BLEND_MULT</code>  <code>gui.BLEND_SCREEN</code> 
...
---@param blend_mode constant blend mode to set  <code>gui.BLEND_ALPHA</code>  <code>gui.BLEND_ADD</code>  <code>gui.BLEND_ADD_ALPHA</code>  <code>gui.BLEND_MULT</code>  <code>gui.BLEND_SCREEN</code> 
...
---Docs: https://defold.com/ref/stable/gui/?q=gui.get_material#gui.get_material
---
...
---Docs: https://defold.com/ref/stable/gui/?q=gui.set_material#gui.set_material
---
...
---Docs: https://defold.com/ref/stable/gui/?q=gui.reset_material#gui.reset_material
---
...
---@overload fun(node: node): boolean
...
---@return node|nil parent parent instance or <code>nil</code>
...
---Docs: https://defold.com/ref/stable/gui/?q=gui.get_tree#gui.get_tree
---
...
---@return quat rotation node rotation
...
---Docs: https://defold.com/ref/stable/gui/?q=gui.get_euler#gui.get_euler
---
---Returns the rotation of the supplied node.
...
---Docs: https://defold.com/ref/stable/gui/?q=gui.set_euler#gui.set_euler
---
---Sets the rotation of the supplied node.
---The rotation is expressed in degree Euler angles.
---@param node node node to set the rotation for
...
---@return boolean|nil consume optional boolean to signal if the input should be consumed (not passed on to others) or not, default is false
