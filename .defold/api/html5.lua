...
---@param callback function(self)|nil The interaction callback. Pass an empty function or <code>nil</code> if you no longer wish to receive callbacks.  <code>self</code> object The calling script 
