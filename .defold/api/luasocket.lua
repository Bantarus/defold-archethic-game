...
---@overload fun(recvt: table, sendt: table): table, table, string|nil
...
---@return string|nil error an error message. "timeout" if a timeout condition was met, otherwise <code>nil</code>.
...
---@return master|nil tcp_master a new IPv6 TCP master object, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred.
...
---@return unconnected|nil udp_unconnected a new unconnected IPv6 UDP object, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred.
...
---@return string|nil hostname the canonic host name of the given address, or <code>nil</code> in case of an error.
...
---@return string|nil ip_address the first IP address found for the hostname, or <code>nil</code> in case of an error.
---@return table|string resolved a table with all information returned by the resolver, or if an error occurs, the error message string.
...
---@return table|nil resolved a table with all information returned by the resolver, or if an error occurs, <code>nil</code>.
---@return string|nil error the error message, or <code>nil</code> if no error occurred.
...
---@overload fun(address: string, port: number): client|nil, string|nil
---@overload fun(address: string, port: number, locaddr: string|nil): client|nil, string|nil
---@overload fun(address: string, port: number, locaddr: string|nil, locport: number|nil): client|nil, string|nil
---@return client|nil tcp_client a new IPv6 TCP client object, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred.
...
---@return unconnected|nil udp_unconnected a new unconnected IPv4 UDP object, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred.
...
---@overload fun(d: number): any|nil, any|nil, any|nil
---@overload fun(d: number, ret1: any|nil): any|nil, any|nil, any|nil
---@overload fun(d: number, ret1: any|nil, ret2: any|nil): any|nil, any|nil, any|nil
...
---@return master|nil tcp_master a new IPv4 TCP master object, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred.
...
---@return client|nil tcp_client if a connection is successfully initiated, a client object is returned, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred. The error is <code>"timeout"</code> if a timeout condition is met.
...
---@return number|nil status the value <code>1</code>, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred.
...
---@overload fun(): string|nil, string|nil, string|nil
---@overload fun(pattern: string|number|nil): string|nil, string|nil, string|nil
---@return string|nil data the received pattern, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred. The error message can be the string <code>"closed"</code> in case the connection was closed before the transmission was completed or the string <code>"timeout"</code> in case there was a timeout during the operation.
---@return string|nil partial a (possibly empty) string containing the partial that was received, or <code>nil</code> if no error occurred.
...
---@overload fun(data: string): number|nil, string|nil, number|nil
---@overload fun(data: string, i: number|nil): number|nil, string|nil, number|nil
---@return number|nil index the index of the last byte within [i, j] that has been sent, or <code>nil</code> in case of error. Notice that, if <code>i</code> is 1 or absent, this is effectively the total number of bytes sent.
---@return string|nil error the error message, or <code>nil</code> if no error occurred. The error message can be <code>"closed"</code> in case the connection was closed before the transmission was completed or the string <code>"timeout"</code> in case there was a timeout during the operation.
---@return number|nil lastindex in case of error, the index of the last byte within [i, j] that has been sent. You might want to try again from the byte following that. <code>nil</code> if no error occurred.
...
---@overload fun(option: string): number|nil, string|nil
---@return number|nil status the value <code>1</code>, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred.
...
---@return any|nil value the option value, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred.
...
---@return number|nil success the value <code>1</code> in case of success, or <code>nil</code> in case of error.
...
---@overload fun(): string|nil, string|nil
---@return string|nil datagram the received datagram, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred.
...
---@overload fun(): string|nil, string, number|nil
---@return string|nil datagram the received datagram, or <code>nil</code> in case of error.
---@return string ip_or_error the IP address, or the error message in case of error.
---@return number|nil port the port number, or <code>nil</code> in case of error.
...
---@return number|nil success the value <code>1</code> on success, or <code>nil</code> in case of error.
---@return string|nil error the error message, or <code>nil</code> if no error occurred.
