...
---Docs: https://defold.com/ref/stable/model/?q=model.set_mesh_enabled#model.set_mesh_enabled
---
...
---Docs: https://defold.com/ref/stable/model/?q=model.get_mesh_enabled#model.get_mesh_enabled
---
