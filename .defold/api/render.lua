...
---
---
---<code>min_filter</code> (optional)
---<code>render.FILTER_LINEAR</code><code>render.FILTER_NEAREST</code>
---
---
---<code>mag_filter</code> (optional)
---<code>render.FILTER_LINEAR</code><code>render.FILTER_NEAREST</code>
---
---
---<code>u_wrap</code>     (optional)
...
---
---
---<code>v_wrap</code>     (optional)
---<code>render.WRAP_CLAMP_TO_BORDER</code><code>render.WRAP_CLAMP_TO_EDGE</code><code>render.WRAP_MIRRORED_REPEAT</code><code>render.WRAP_REPEAT</code>
---
---
---<code>flags</code>      (optional)
---<code>render.TEXTURE_BIT</code> (only applicable to depth and stencil buffers)
---
---
---
...
---@param buffer_type constant|nil optional buffer type from which to enable the texture. Note that this argument only applies to render targets. Defaults to <code>render.BUFFER_COLOR_BIT</code>. These values are supported:  <code>render.BUFFER_COLOR_BIT</code>  If The render target has been created as depth and/or stencil textures, these buffer types can be used:  <code>render.BUFFER_DEPTH_BIT</code>  <code>render.BUFFER_STENCIL_BIT</code>  If the render target has been created with multiple color attachments, these buffer types can be used to enable those textures as well. Currently 4 color attachments are supported:  <code>render.BUFFER_COLOR0_BIT</code>  <code>render.BUFFER_COLOR1_BIT</code>  <code>render.BUFFER_COLOR2_BIT</code>  <code>render.BUFFER_COLOR3_BIT</code> 
---@overload fun(binding: number|string|hash, handle_or_name: texture|string|hash)
...
---@param buffer_type constant which type of buffer to retrieve the width from  <code>render.BUFFER_COLOR_BIT</code>  <code>render.BUFFER_COLOR[x]_BIT</code> (x: [0..3], if supported!)  <code>render.BUFFER_DEPTH_BIT</code>  <code>render.BUFFER_STENCIL_BIT</code> 
...
---@param options {frustum:vmath.matrix4, frustum_planes:int, constants:constant_buffer}|nil optional table with properties
...
---@param options {frustum:vmath.matrix4, frustum_planes:int}|nil optional table with properties
---@overload fun()
...
---Docs: https://defold.com/ref/stable/render/?q=render.set_camera#render.set_camera
---
...
---@overload fun(camera: url|handle|nil)
