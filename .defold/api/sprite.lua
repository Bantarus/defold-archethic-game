...
---@overload fun(url: string|hash|url, id: string|hash)
---@overload fun(url: string|hash|url, id: string|hash, complete_function: fun(self:object, message_id:hash, message:{current_tile:number, id:hash}, sender:url)|nil)
