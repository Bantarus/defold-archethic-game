...
---Docs: https://defold.com/ref/stable/sys/?q=sys.load_buffer#sys.load_buffer
---
...
---@return buffer buffer the buffer with data
function sys.load_buffer(path) end

---Docs: https://defold.com/ref/stable/sys/?q=sys.load_buffer_async#sys.load_buffer_async
---
---The sys.load_buffer function will first try to load the resource
---from any of the mounted resource locations and return the data if
---any matching entries found. If not, the path will be tried
...
---Docs: https://defold.com/ref/stable/sys/?q=sys.exists#sys.exists
---
---Check if a path exists
---Good for checking if a file exists before loading a large file
---@param path string path to check
---@return bool result <code>true</code> if the path exists, <code>false</code> otherwise
function sys.exists(path) end

---Docs: https://defold.com/ref/stable/sys/?q=sys.get_host_path#sys.get_host_path
---
...
---@return string|nil data loaded data, or <code>nil</code> if the resource could not be loaded
...
---@overload fun(): {device_model:string, manufacturer:string, system_name:string, system_version:string, api_version:string, language:string, device_language:string, territory:string, gmt_offset:number, device_ident:string, user_agent:string}
