...
---Docs: https://defold.com/ref/stable/timer/?q=timer.get_info#timer.get_info
---
---Get information about timer.
---@param handle hash the timer handle returned by timer.delay()
---@return table|nil data table or <code>nil</code> if timer is cancelled/completed. table with data in the following fields:  <code>time_remaining</code> number Time remaining until the next time a timer.delay() fires. <code>delay</code> number Time interval. <code>repeating</code> boolean true = repeat timer until cancel, false = one-shot timer. 
