...
---@param callback function(self, event, data)|nil A callback which receives info about window events. Pass an empty function or <code>nil</code> if you no longer wish to receive callbacks.  <code>self</code> object The calling script <code>event</code> constant The type of event. Can be one of these:   <code>window.WINDOW_EVENT_FOCUS_LOST</code>  <code>window.WINDOW_EVENT_FOCUS_GAINED</code>  <code>window.WINDOW_EVENT_RESIZED</code>  <code>window.WINDOW_EVENT_ICONIFIED</code>  <code>window.WINDOW_EVENT_DEICONIFIED</code>   <code>data</code> table The callback value <code>data</code> is a table which currently holds these values   number <code>width</code>: The width of a resize event. nil otherwise.  number <code>height</code>: The height of a resize event. nil otherwise. 
